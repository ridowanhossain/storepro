...
<div class="row">
    <div class="col-md-12">
        ...
        <ol class="breadcrumb">
		  ...
		  <li class="active"> নিষ্ক্রিয় পণ্য</li>
		</ol>

		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> নিষ্ক্রিয় পণ্য পরিচালনা</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px; visibility:hidden;">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-edit"></i> নিষ্ক্রিয় পণ্য সম্পাদনা</h4>
	      </div>
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
							    ...
							    <div class="kv-avatar center-block">
							        <input type="file" class="form-control" id="editProductImage" placeholder="Product Name" name="editProductImage" class="file-loading" style="width:auto;" disabled="" />
							    </div>
						    </div>
			        </div> <!-- /form-group-->
				    ...
				    <div role="tabpanel" class="tab-pane" id="productInfo">
				    	...
				    	<div class="form-group">
			        		<label for="editProductName" class="col-sm-3 control-label">পণ্যের নাম</label>
	        	 			<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editProductName" placeholder="পণ্যের নাম" name="editProductName" autocomplete="off" readonly <?php  if($_SESSION['Status']!=='5'){echo'readonly';} ?>>
						    </div>
			        </div> <!-- /form-group-->
			        ...
			        <div class="form-group">
			          ...
			          <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="addpro" placeholder="পরিমাণ যোগ করুন" name="addpro" autocomplete="off" value="" readonly>
						    </div>
			        </div> <!-- /form-group-->
		        ...
		        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select class="form-control" id="editclor" name="editclor" readonly <?php  if($_SESSION['Status']!=='5'){echo'readonly';} ?>>
				 	...
				 	<div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editbRate" placeholder="ক্রয়মূল্য" name="editbRate" autocomplete="off" readonly <?php  if($_SESSION['Status']!=='5'){echo'readonly';} ?>>
						    </div>
			        </div>
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editRate" placeholder="বিক্রয়মূল্য" name="editRate" autocomplete="off" readonly <?php  if($_SESSION['Status']!=='5'){echo'readonly';} ?>>
						    </div>
			        </div> <!-- /form-group-->
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select class="form-control" id="editBrandName" name="editBrandName" readonly <?php  if($_SESSION['Status']!=='5'){echo'readonly';} ?>>
			        ...
			        <div class="form-group">
			        	...
			        	<label class="col-sm-1 control-label">: </label>
						    <div class="col-sm-8">
						      <select type="text" class="form-control" id="editCategoryName" name="editCategoryName" readonly <?php  if($_SESSION['Status']!=='5'){echo'readonly';} ?>>
						      	<option value="">~~নির্বাচন করুন~~</option>
						      	<?php
	      	...
	      	<div class="form-group">
	        		<label for="editfeature" class="col-sm-3 control-label">বৈশিষ্ট্য </label>
	        	 	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				     <textarea <?php  if($_SESSION['Status']!=='5'){echo'readonly';} ?> name="editfeature" id="editfeature" cols="30" rows="10" readonly></textarea>
				    </div>
	        </div> <!-- /form-group-->
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeProductModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> নিষ্ক্রিয় পণ্য অপসারণ</h4>
      </div>
      <div class="modal-body">

      	<div class="removeProductMessages"></div>

        <p>আপনি কি সত্যিই এই নিষ্ক্রিয় পণ্যটি অপসারণ করতে চান ?</p>
      </div>
