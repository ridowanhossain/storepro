...
<div class="main-table">
	<div class="product-table-card">
		<div class="table-title">
			<i class="fa fa-calculator"></i> <span>ক্রেতার তালিকা</span>
		</div>
			<div style="margin-bottom: 20px; display: flex; justify-content: flex-end;">
				<button class="btn btn-modern" type="button" data-toggle="modal" data-target="#addSrProduct"><i class="glyphicon glyphicon-plus-sign"></i> ক্রেতা যোগ করুন</button>
			</div>
			<table class="table table-bordered modern-table dataTable no-footer dtr-inline" id="manageisrtable">
				<thead>
					<tr>
