		...
		<div class="main-table">
			<div class="product-table-card">
				<div class="table-title">
					<i class="glyphicon glyphicon-edit"></i> সক্রিয় পণ্য পরিচালনা
				</div> 
				...
				<div class="row" style="margin-bottom: 25px;">
					<div class="col-md-8">
						<a type="button" onclick="printOrder('1')" class="btn btn-modern"> <i class="glyphicon glyphicon-print"></i> প্রিন্ট </a>
						<a type="button" onclick="printOrder0('1')" class="btn btn-modern" style="margin-left: 10px;"> <i class="glyphicon glyphicon-print"></i> স্টক প্রিন্ট </a>
					</div>
					<div class="col-md-4 text-right">
						<?php if($_SESSION['Status']=='5' || $_SESSION['Status']=='2') { ?>
							<button class="btn btn-modern" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> পণ্য যুক্ত করুন </button>
						<?php } ?>
					</div>
				</div>
	
				<table class="table table-bordered modern-table dataTable no-footer dtr-inline" id="manageProductTable">
					<thead>
						<tr>
							<th class="text-center">ক্রমিক</th>
							<th class="text-center" style="width:10%;">ছবি</th>
							<th class="text-center">কোড</th>
							<th class="text-center">ব্র্যান্ড</th>
							<th class="text-center">পণ্যের নাম</th>
							<th class="text-center">পণ্যের শ্রেণী</th>
							<th class="text-center">বৈশিষ্ট্য</th>
							<th class="text-center">ক্রয়মূল্য</th>
							<th class="text-center">বিক্রয়মূল্য</th>
							<th class="text-center">পরিমাণ</th>
							<th class="text-center">পরিমাপ</th>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-footer">
	        <button type="button" class="btn btn-default" data-dismiss="modal" style="border-radius: 8px;"> <i class="glyphicon glyphicon-remove-sign"></i> বাতিল</button>

	        <button type="submit" class="btn btn-modern" id="createProductBtn" data-loading-text="Loading..." autocomplete="off"> <i class="glyphicon glyphicon-ok-sign"></i> সংরক্ষণ করুন</button>
	      </div> <!-- /modal-footer -->
     	</form> <!-- /.form -->
    </div> <!-- /modal-content -->
  </div> <!-- /modal-dailog -->
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
			        ...
			        <div class="modal-footer editProductFooter">
				        ...
				        <button type="submit" class="btn btn-modern" id="editProductBtn" data-loading-text="্লোড হচ্ছে..."> <i class="glyphicon glyphicon-ok-sign"></i> সংরক্ষণ করুন</button>
				      </div> <!-- /modal-footer -->
			        </form> <!-- /.form -->
				    </div>
				    <!-- /product info -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer removeProductFooter">
        <button type="button" class="btn btn-default" data-dismiss="modal" style="border-radius: 8px;"> <i class="glyphicon glyphicon-remove-sign"></i> বাতিল</button>
        <button type="button" class="btn btn-modern" id="removeProductBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-ok-sign"></i> সংরক্ষণ করুন</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<script src="custom/js/product.js?v=<?php echo filemtime('custom/js/product.js'); ?>"></script>
