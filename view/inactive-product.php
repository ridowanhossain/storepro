...
<div class="row">
    <div class="col-md-12">
        ...
        <ol class="breadcrumb">
		  ...
		  <li class="active"> নিষ্ক্রিয় পণ্য</li>
		</ol>

		<div class="main-table">
			<div class="product-table-card">
				<div class="table-title">
					<i class="glyphicon glyphicon-edit"></i> <span>নিষ্ক্রিয় পণ্য পরিচালনা</span>
				</div>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> নিষ্ক্রিয় পণ্য সংযুক্ত করুন</h4>
	      </div>
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <select class="form-control" id="productStatus" name="productStatus" disabled>
				        ...
				        <option value="2" selected>নিষ্ক্রিয়</option>
				      </select>
				      <input type="hidden" name="productStatus" value="2">
				    </div>
	        </div> <!-- /form-group-->
...
<div class="modal fade" id="editProductModal" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
	      ...
	      <div class="modal-header">
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	        <h4 class="modal-title"><i class="fa fa-edit"></i> নিষ্ক্রিয় পণ্য সম্পাদনা</h4>
	      </div>
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeProductModal">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><i class="glyphicon glyphicon-trash"></i> নিষ্ক্রিয় পণ্য অপসারণ</h4>
      </div>
      <div class="modal-body">

      	<div class="removeProductMessages"></div>

        <p>আপনি কি সত্যিই এই নিষ্ক্রিয় পণ্যটি অপসারণ করতে চান ?</p>
      </div>
...
<script src="custom/js/inactive-product.js?v=<?php echo filemtime('custom/js/inactive-product.js'); ?>"></script>
