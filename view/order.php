...
<ol class="breadcrumb">
	...
	<li class="active">
		...
		<?php } else if ($_GET['o'] == 'manord') { ?>
			কুইক অর্ডার পরিচালনা
		<?php } else if ($_GET['o'] == 'editOrd') { ?>
			কুইক অর্ডার সম্পাদনা
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if ($_GET['o'] == 'add') { ?>
			<i class="glyphicon glyphicon-plus-sign"></i> কুইক অর্ডার
		<?php } else if ($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> কুইক অর্ডার পরিচালনা
		<?php } else if ($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> কুইক অর্ডার সম্পাদনা
		<?php } ?>
	...
	<div class="panel-body">
				...
				<table class="table" id="productTable">
					<thead>
						<tr>
							...
							<th>পরিমাপ</th>
							<th>দাম</th>
							<th class="text-center add-th"><button type="button" class="btn btn-default add-r" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> সারি যুক্ত করুন </button>
							</th>
						</tr>
					</thead>
					<tbody>
						...
						for ($x = 1; $x < 2; $x++) { ?>
							<tr id="row<?php echo $x; ?>" class="table-order <?php echo $arrayNumber; ?>">
								...
								<td>
									<div class="form-group">
										<input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" min="0" />
									</div>
								</td>
								<td>
									<div class="form-group">
		...
		?>
			...
			<table class="table table-bordered table-condensed table-hover table-striped dataTable no-footer" id="manageOrderTable">
				<thead>
					<tr>
						<th>ক্রমিক</th>
						<th>আইডি</th>
		...
		<div class="modal-content">
			...
			<div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" id="payAmount" name="payAmount" onkeyup="calculateRemainingDue()" />
					</div>
				</div> <!--/form-group-->
				<div class="form-group">
					<label for="remainingDue" class="col-sm-3 control-label">অবশিষ্ঠ বাঁকি ৳</label>
					<div class="col-sm-9">
						<input type="text" class="form-control" id="remainingDue" disabled="true" />
					</div>
				</div> <!--/form-group-->
				<div class="form-group">
					<label for="clientContact" class="col-sm-3 control-label">পরিশোধের ধরন</label>
