...
<div class="main-table">
	<div class="product-table-card">
		<div class="table-title">
			<i class="fa fa-calculator"></i> <span>নিষ্ক্রিয় ক্রেতার তালিকা</span>
		</div>
			...
			<form id="editprevForm" action="php_action/editprevdue.php" method="POST" role="form">
				...
				<div id="edit-prev-messages"></div>
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="form-group">
								<input type="text" name="paidnow" id="paidnow" class="form-control input-lg" onkeyup="pdueFunc()" value="0" placeholder="পরিশোধ করুন">
							</div>
						</div>
					</div>
				</div>
