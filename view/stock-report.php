...
<ol class="breadcrumb">
  ...
  <li class="active">স্টক/ফেরতের প্রতিবেদন</li>
</ol>
		...
		<div class="main-table">
			<div class="product-table-card">
				<div class="table-title">
					<i class="glyphicon glyphicon-check"></i> <span>স্টক/ফেরতের প্রতিবেদন</span>
				</div>
...
<script src="custom/js/stockreport.js?v=<?php echo filemtime('custom/js/stockreport.js'); ?>"></script>
