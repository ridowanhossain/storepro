...
<ol class="breadcrumb">
  ...
  <li>ক্রেতা</li>
  <li class="active">সক্রিয় ক্রেতা</li>
</ol>

<div class="main-table">
    <div class="product-table-card">
        <div class="table-title">
            <i class="fa fa-calculator"></i> <span>সক্রিয় ক্রেতার তালিকা</span>
        </div>
            <div class="remove-sr-messages"></div>
            
            <div style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: center;">
                <a type="button" onclick="printOrder('3')" class="btn btn-modern"> <i class="glyphicon glyphicon-print"></i> প্রিন্ট </a>
                <button class="btn btn-modern" type="button" data-toggle="modal" data-target="#addSrProduct">
                    <i class="glyphicon glyphicon-plus-sign"></i> ক্রেতা যোগ করুন
                </button>
            </div>
            ...
            <table class="table table-bordered modern-table dataTable no-footer dtr-inline" id="managesrtable">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">অতিরিক্ত জমা</th>
			...
			<form id="submitsrForm" action="php_action/creatSr.php" method="POST" role="form">
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6">
							<div class="form-group">
			  					 <select class="form-control input-lg" id="user-role" name="user" disabled>
							      	<option value="">~~নির্বাচন করুন~~</option>
							      	<option value="1" selected>সক্রিয়  ক্রেতা</option>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<form id="editprevForm" action="php_action/editprevdue.php" method="POST" role="form">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"></span></button>
					<h4 class="modal-title">বাঁকি যুক্ত করুন</h4>
				</div>
				<div class="modal-body">
				<div id="edit-prev-messages"></div>
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<div class="form-group">
								<label for="tdue">বাঁকির পরিমাণ</label>
								<input type="text" name="tdue" id="tdue" class="form-control input-lg" placeholder="পরিমাণ">
							</div>
						</div>
					</div>
				</div>
...
<script src="custom/js/sr.js?v=<?php echo filemtime('custom/js/sr.js'); ?>"></script>
