...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if ($_GET['o'] == 'add') { ?>
			<i class="glyphicon glyphicon-plus-sign"></i> নিয়মিত অর্ডার
		<?php } else if ($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> নিয়মিত অর্ডার পরিচালনা
		<?php } else if ($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> নিয়মিত অর্ডার সম্পাদনা
		<?php } ?>
	...
	<div class="panel-body">
			...
			<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
				...
				<div class="col-sm-5 col-sm-offset-1">
					<div class="form-group order-group">
						...
						<select class="form-control todo select2" name="nmbr" id="nmbr">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" value="0" />
						</div>
					</div> <!--/form-group-->
					<div class="form-group">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="number" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" value="0" />
						</div>
					</div> <!--/form-group-->
					<div class="form-group">
		...
		?>
			...
			<form class="form-horizontal row" method="POST" action="php_action/editOrder.php" id="editOrderForm">
				...
				$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, orders.client_contact, orders.sub_total, orders.vat, orders.total_amount, orders.discount, orders.grand_total, orders.paid, orders.due, orders.payment_type, orders.payment_status, orders.address,users.full_name FROM orders inner join users on
				...
				<div class="col-md-6">
					<div class="form-group">
						<label for="paid" class="col-sm-3 control-label">পরিশোধিত টাকা</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" value="<?php echo $data[9] ?>" readonly />
						</div>
					</div> <!--/form-group-->
					<div class="form-group">
						<label for="due" class="col-sm-3 control-label">বাঁকি</label>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body form-horizontal" style="max-height:500px; overflow:auto;">
				...
				<div class="form-group">
					<label for="sr_id" class="col-sm-3 control-label">Sr id </label>
					<div class="col-sm-9">
						<input type="hidden" class="form-control" id="sr_id" name="sr_id" />
					</div>
				</div> <!--/form-group-->
				...
				<div class="form-group">
					<label for="payAmount" class="col-sm-3 control-label">পরিশোধ</label>
					<div class="col-sm-9">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<select class="form-control" name="paymentStatus" id="paymentStatus">
							<option value="3">বাঁকি</option>
							<option value="1">পুরোপুরি পরিশোধ</option>
							<option value="2">অগ্রিম পরিশোধ</option>
						</select>
					</div>
				</div> <!--/form-group-->
