                ...
                if (response.success == true) {
                  ...
                  $(".success-messages").html(
                    '<div class="alert alert-success">' +
                      ...
                      '<a href="order?o=add" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> কুইক অর্ডার </a>' +
                      '<a href="regular-order?o=add" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> নিয়মিত অর্ডার </a>' +
                      "</div>"
                  );
...
function paidAmount() {
  ...
  if (grandTotal && paid) {
    ...
    var paid = $("#paid").val();
    var dueValue = Number(grandTotalValue) - Number(paid);
