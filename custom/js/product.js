...
$(document).ready(function () {
  ...
  manageProductTable = $("#manageProductTable").DataTable({
    ...
    tableTools: {
      sSwfPath:
        "assests/plugins/datatables/extensions/TableTools/swf/copy_csv_xls_pdf.swf",
  ...
  if (productId) {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#getProductImage")
          .attr("src", "stock/" + response.product_image)
          .on("error", function () {
...
// print order without product <0 and 0 function
function printOrder0() {
  if ("1") {
    $.ajax({
      url: "php_action/printproduct0.php",
      type: "post",
      data: { 1: "1" },
      dataType: "text",
      success: function (response) {
