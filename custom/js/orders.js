  ...
  if (divRequest == "add") {
                ...
                if (response.success == true) {
                  ...
                  $(".success-messages").html(
                    '<div class="alert alert-success">' +
                      ...
                      '<a href="quick-order" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> অর্ডার করুন </a>' +
                      '<a href="regular-order" class="btn btn-default" style="margin-left:10px;"> <i class="glyphicon glyphicon-plus-sign"></i> নিয়মিত অর্ডার করুন </a>' +
                      "</div>",
                  );
    ...
    $("#rmanageOrderTable").before(
      '<div class="filter-container">' +
        ...
        '<a href="regular-order" class="btn btn-success"><i class="fa fa-plus-circle"></i> অর্ডার করুন</a>' +
        "</div>" +
        "</div>" +
        "</div>" +
        "</div>",
    ...
    $("#printOrder").on("click", function () {
      const printContents = $("#rmanageOrderTable").prop("outerHTML");
