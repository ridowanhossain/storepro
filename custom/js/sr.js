      ...
      success: function (response) {
        ...
        $("#editprevForm")
          ...
          .bind("submit", function () {
            ...
            var brandName = $("#tdue").val();

            if (brandName == "") {
              $("#tdue").after(
                '<p class="text-danger">Total field is required</p>',
              );
              $("#tdue").closest(".form-group").addClass("has-error");
            } else {
              // remov error text field
              $("#tdue").find(".text-danger").remove();
              // success out for form
              $("#tdue").closest(".form-group").addClass("has-success");
            }
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        mywindow.document.write(
          "<html><head><title>Active User Report</title>",
        );
        mywindow.document.write(
