...
$sql = "SELECT orders.order_id, orders.order_date, orders.client_name, 
        ...
        users.full_name, orders.o_feature, orders.due, orders.paid, orders.grand_total
    FROM orders 
    INNER JOIN users ON users.user_id = orders.s_name 
...
while($row = $result->fetch_array()) {
    ...
    $button .='<li><a type="button" href="quick-order-view='.$orderId.'" target="_blank"> <i class="fa fa-file-text"></i> প্রতিবেদন</a></li>
