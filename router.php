...
// Handle edit quick order URL pattern (static or with ID)
if ($route === 'quick-order-edit') {
    $route = 'order';
    $_GET['o'] = 'editOrd';
} else if (strpos($route, 'quick-order-edit=') === 0) {
...
if ($route === 'regular-order-edit') {
    $route = 'order-regular';
    $_GET['o'] = 'editOrd';
} else if (strpos($route, 'regular-order-edit=') === 0) {
...
// Handle edit-order format (Redundant check but kept for safety)
